...
Vue.component('masa-component', require('./components/TipomasaComponent.vue').default);
...
Vue.component('orden-component',require('./components/OrdenComponent.vue').default);

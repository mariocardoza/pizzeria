        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="card card-info">
                    <div class="card-header">Pizza de un ingrediente</div>
                    ...
                    <div class="form-row">
                        ...
                        <div class="col">
                            <div v-if="nuevo">
                                Ingrediente
                                <select v-model="ingredient" class="form-control">
                                    <option value="">Seleccione</option>
                        ...
                        <table  class="table">
                            ...
                            <tbody>
                                <tr v-for="(pizza,index) in pizzas.data">
                                    ...
                                    <td><li>{{pizza.ingredient.nombre}}</li></td>
                                    <td>
...
<script>
    export default {
        ...
        methods: {
            ...
            savePizza: function () {
                axios.post('/api/basics',{nombre:this.nombre,precio:this.precio,masa:this.masa,size:this.size,ingredient:this.ingredient})
                .then((response)=>{
            ...
            getPage(page){
                axios.get('/api/basics?page='+page).then((response)=>{
                    this.$set(this.$data, 'basics', response.data);
                },(response)=>{
                });
            },
            getPreviousPage(){
